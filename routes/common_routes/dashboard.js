        ...
        if (req.isAuthenticated()) {
            ...
            if (user.isCustomer()) {
                ...
                .then((result) => {
                    ...
                    res.render('customer_views/customer_dashboard.ejs', render_info)
                })
            ...
            if(user.isWorker()) {
                res.render('worker_views/worker_dashboard.ejs');
            ...
            if(user.isReviewer()) {
                ...
                pool.connect(function (err, client, done) {
                    ...
                    client.query('select * from projects_metadata order by starttime desc limit 10', function (err, result) {
                        ...
                        client.release();
                        res.render('reviewer_views/reviewer_dashboard.ejs', {list: result});
                    });
                })
            }
            ...
            if(user.isNewbie() || user.isBeginner()) {
                ...
                console.log(user);
                res.render('worker_views/dashboard.ejs', {name: name, level: user.role});
            }
